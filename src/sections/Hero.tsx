...
export default function Hero() {
  return (
    <section id="hero" className="min-h-[calc(100vh-80px)] flex items-center justify-center relative overflow-hidden">
      {/* Video Background Placeholder (Silakan ganti src dengan path video walpaper Anda) */}
      <div className="absolute inset-0 w-full h-full z-0 overflow-hidden opacity-30 dark:opacity-50">
        <video
          autoPlay
          loop
          muted
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        >
          <div className="relative w-72 h-72 md:w-96 md:h-96">
            {/* Decorative background video/shape behind avatar */}
            <div className="absolute inset-0 rounded-full blur-xl opacity-50 dark:opacity-60 scale-110 overflow-hidden animate-pulse">
              {/* Video di Belakang Profil (Opsional) */}
              <video
                autoPlay
                loop
                muted
            ...
            <div className="relative w-full h-full rounded-full border-4 border-white dark:border-slate-800 shadow-2xl overflow-hidden animate-float bg-slate-200 dark:bg-slate-700 flex items-center justify-center">
              ...
              <svg className="absolute w-3/4 h-3/4 text-slate-400 dark:text-slate-500 mt-8 z-0" fill="currentColor" viewBox="0 0 24 24">
